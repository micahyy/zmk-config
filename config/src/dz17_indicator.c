...
static void refresh_all(void) {
    ...
    /* Channel LEDs are BLE-transport ONLY: in USB mode they stay dark
     * the whole time (the BLE link may stay alive over the cable, but the
     * LEDs report the selected output). Feedback:
